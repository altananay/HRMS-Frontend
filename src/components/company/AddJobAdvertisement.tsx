                    ...
                    <div className="card-body px-4 py-5 px-md-5">
                      <div className="row">
                        <div className="form-outline mb-4">
                          <label className="form-label">İş ilanı başlığı</label>
                          <Field
                            name="title"
                            type="text"
                            className={
                            ...
                            >
                              {cities
                                ? Object.keys(cities).map((i) => {
                                    return (
                                      <option key={i} value={cities[i]} id={i}>
                                        {cities[i]}
                                      </option>
                                    );
                                  })
                        ...
                        <div className="col-md-6 mb-4">
                          <div className="form-outline">
                            ...
                            <Field
                              ...
                              className={
                                "form-control " +
                                (touched.openPosition && errors.openPosition
                                  ? "is-invalid"
                                  : null)
                              }
                            />
                      ...
                      <div className="form-outline mb-4">
                        <label className="form-label">İstenen Nitelikler</label>
                        <Field
