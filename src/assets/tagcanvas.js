(function () {
  ...
  function TextSet(
    ...
    shadowOffsets.length &&
      (ctxt.shadowOffsetX =
        shadowOffsets[0] && (ctxt.shadowOffsetY = shadowOffsets[1]));
  ...
  function TouchUp(e) {
    ...
    if (tc && e.changedTouches) {
      switch (tc.touchState) {
        ...
        default:
          tc.touchState = 0;
          console.log("tagcanvas switch-case default");
          break;
      }
    }
  }
  ...
  Tproto.Clicked = function (e) {
    var a = this.a,
      ...
      evt;
    if (t !== "" && t !== "_self") {
      if (window.self.frames[t]) {
        window.self.frames[t].document.location = h;
      } else {
        try {
          if (window.top.frames[t]) {
            window.top.frames[t].document.location = h;
            return;
          }
        } catch (err) {
